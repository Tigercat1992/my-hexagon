...
Link to my video series about the process of step by step creation of hexagonal grid and field of view: https://www.youtube.com/playlist?list=PLshG9vHWHGOgPIs2oarf1ZBTho5Jbg9JF
*/
...
class OriginCanvas extends React.Component {
    constructor(props) {
        super(props);
    ...
    shouldComponentUpdate(nextProps, nextState) {
        if (nextState.cameFrom !== this.state.cameFrom) {
            ...
            for (let l in nextState.cameFrom) {
                ...
                this.drawHex(this.canvasView, this.Point(x, y), 1, "#6bff02", "transparent", 0);
            }
            return true;
        }
        ...
        for (let r = 0; r <= rBottomSide; r++) {
            ...
            for (let q = -qLeftSide; q <= qRightSide; q++) {
                ...
                if ((x > hexWidth / 2 && x < canvasWidth - hexWidth / 2) && (y > hexHeight / 2 && y < canvasHeight - hexHeight / 2)) {
                    this.drawHex(this.canvasHex, this.Point(x, y), 1, "black", "transparent");
    ...
    render() {
        return (
          <div>
              ...
              <canvas id="canvasHex" ref={canvasHex => this.canvasHex = canvasHex }> </canvas>
